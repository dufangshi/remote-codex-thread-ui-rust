    ...
    ReactMarkdown,
    {
      ...
      components: {
        ...
        img({ src, alt }) {
          ...
          return /* @__PURE__ */ jsx32("img", { src: resolved, alt: alt ?? "" });
        },
                ...
                /* @__PURE__ */ jsxs45("div", { className: "min-h-0 flex-1 overflow-auto px-5 py-4", children: [
                  ...
                  actionMode === "link" ? linkContent : actionMode === "share" ? /* @__PURE__ */ jsxs45("form", { id: "thread-actions-share-form", className: "mt-4 space-y-4", onSubmit: handleShare, children: [
                    ...
                    /* @__PURE__ */ jsxs45("div", { className: "thread-export-dialog-body-text mt-4 grid gap-2 text-sm sm:grid-cols-2", children: [
                      ...
                      /* @__PURE__ */ jsx54("p", { className: "thread-export-dialog-box thread-export-dialog-subtitle flex items-center rounded-xl border px-3 py-2 text-xs", children: actionMode === "html" ? "HTML keeps the chat timeline styling and omits raw command output." : "Opens your browser\u2019s Save as PDF dialog with the same chat styling." })
                    ] })
                  ] })
                ] }),
