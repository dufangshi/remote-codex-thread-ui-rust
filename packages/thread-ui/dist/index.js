...
function MatterWorkbench({
  ...
  const [toolbarOpen, setToolbarOpen] = useState15(false);
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs21("main", { className: "matter-main", children: [
          /* @__PURE__ */ jsxs21("div", { className: "matter-tabs-row", children: [
            /* @__PURE__ */ jsxs21("nav", { ref: tabsRef, className: "matter-thread-tabs", "aria-label": "Workspace threads", children: [
          ...
          /* @__PURE__ */ jsxs21(
            "section",
            {
              ...
              children: [
                ...
                o.notifications.length ? [...o.notifications].sort((a, b) => Date.parse(b.occurredAt) - Date.parse(a.occurredAt)).slice(0, 10).map((n) => /* @__PURE__ */ jsxs21(
                  "a",
                  {
                    href: n.href,
                    onClick: (e) => {
  ...
  return /* @__PURE__ */ jsxs38("span", { className: "thread-turn-usage", "data-testid": "turn-usage", children: [
    /* @__PURE__ */ jsxs38(
      "span",
      {
        ...
        children: [
          /* @__PURE__ */ jsx47("span", { className: "thread-turn-usage-model-name", children: turn.model?.trim() || "Model unavailable" }),
