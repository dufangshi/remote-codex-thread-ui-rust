...
var ThreadTurnRow = memo5(function ThreadTurnRow2({
  ...
  const interruptedLabel = turn.status === "interrupted" ? /* @__PURE__ */ jsx43("span", { className: "thread-graph-worked-interrupted shrink-0 text-[11px]", children: "Interrupted by user" }) : null;
